...

{
    ...
    public class Student
    {
        ...
        public List<Student> GetStudents()
        {
            ...
            {
            new Student(){ RollNumber = 1, Name = "Aniket", Age = 22, City = "satara"},
            new Student(){ RollNumber = 2, Name = "Ajay", Age = 21, City = "Mumbai"},
            new Student(){ RollNumber = 3, Name = "ravi", Age = 23, City = "satara"},
            new Student(){ RollNumber = 4, Name = "shweta", Age = 25, City = "Satara"},
            new Student(){ RollNumber = 5, Name = "shruti", Age = 32, City = "Pune"}
            };
        }
    }
}
